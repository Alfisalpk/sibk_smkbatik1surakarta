                ...
                <table id="example2" class="table table-hover table-bordered table-responsive">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style="width: 35vh;">Nama Lengkap</th>
                            <th scope="col" style="width: 35vh;">Nama Orang Tua</th>
                            <th scope="col" style="width: 15vh;">Kelas</th>
                ...
                <form id="editSiswaForm" action="/admin/edit_siswa" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="edit_nama_lengkap" name="username" required>
                        </div>
                        <div class="form-group">
