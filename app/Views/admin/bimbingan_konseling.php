    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="convertBtn">Simpan</button>
            </div>
        </div>
    </div>
</div>
<!-- END BAGIAN TAMBAH TABEL Data PElanggaran -->
        ...
        <div class="row mb-3">
    <div class="col-md-4">
        <form method="GET" action="<?= base_url('admin/bimbingan_konselingfilter') ?>">
...
<button class="btn btn-outline-primary" type="submit">
    ...
    <a href="<?= base_url('admin/bimbingan_konseling') ?>" class="btn btn-outline-secondary">
